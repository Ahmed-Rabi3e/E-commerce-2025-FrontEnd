...
export const NewLoader = () => {
  return (
    <div className="py-2 px-4 flex justify-center items-center w-full h-screen text-4xl text-black text-center font-bold shadow-md focus:outline-none rounded-lg">
      ...
      <span>ading</span>
      <div className="flex space-x-2 justify-center items-center mx-1 mt-6">
